...
mkdir %PROJECTPATH%%SCENARIONAME%\INPUT\trn
...
copy /Y %INPUTFARESPATH%\trnAssign%SCENARIOINDEX%.bat							%PROJECTPATH%%SCENARIONAME%\CTRAMP\scripts\skims\trnAssign.bat

copy /Y %INPUTFARESPATH%\Fare_by_Zone_Seamless_long.csv                         %PROJECTPATH%%SCENARIONAME%\trn
copy /Y %INPUTFARESPATH%\Fare_by_Zone_Seamless_auto_long.csv                    %PROJECTPATH%%SCENARIONAME%\trn
copy /Y %INPUTFARESPATH%\Zone_Lookup_Seamless.csv                          		%PROJECTPATH%%SCENARIONAME%\trn
copy /Y %INPUTFARESPATH%\convert_csv_to_mat.job                       			%PROJECTPATH%%SCENARIONAME%\CTRAMP\scripts\skims\convert_csv_to_mat.job
...
:: the following line calls the script to convert csv to mat
set MODEL_DIR=%CD%
runtpp %PROJECTPATH%%SCENARIONAME%\CTRAMP\scripts\skims\convert_csv_to_mat.job
