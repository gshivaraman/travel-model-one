...
copy /Y
copy /Y %INPUTFARESPATH%\Fare_by_Zone_Option_6.MAT                            	%PROJECTPATH%%SCENARIONAME%\trn
copy /Y %INPUTFARESPATH%\Fare_by_Zone_Option_6_OZL.MAT                          %PROJECTPATH%%SCENARIONAME%\trn
copy /Y %INPUTFARESPATH%\Fare_by_Zone_Option_6_TZL.MAT                          %PROJECTPATH%%SCENARIONAME%\trn
copy /Y %INPUTFARESPATH%\Zone_Lookup_Option_6.csv                          		%PROJECTPATH%%SCENARIONAME%\trn
