CompareStr <- function(workbook1, workbook2) {
  ...
  trip_mode <- trip_mode %>% 
    select("trip_mode", "trips1", "trips2",	"revenue1", "revenue2", "fare1", "fare2",	"bau_fare1", "bau_fare2",	"num_participants1", "num_participants2", "walktime1", "walktime2", "wait1", "wait2", "IVT1", "IVT2", "transfers1", "transfers2", "othercost1", "othercost2", "distance1", "distance2", "dLocal1", "dLocal2", "dRegional1", "dRegional2", "dFree1", "dFree2", "dInterCity1", "dInterCity2", "ddist1", "ddist2", "dFareMat1", "dFareMat2") %>%
    arrange("trip_mode")
  ...
  for (myvar in c("incQ", "timeCodeNum", "ptype")) {
    ...
    mydf <- mydf %>% 
      select(all_of(myvar), "trip_mode", "trips1", "trips2",	"revenue1", "revenue2", "fare1", "fare2",	"bau_fare1", "bau_fare2",	"num_participants1", "num_participants2", "walktime1", "walktime2", "wait1", "wait2", "IVT1", "IVT2", "transfers1", "transfers2", "othercost1", "othercost2", "distance1", "distance2", "dLocal1", "dLocal2", "dRegional1", "dRegional2", "dFree1", "dFree2", "dInterCity1", "dInterCity2", "ddist1", "ddist2", "dFareMat1", "dFareMat2") %>%
  ...
  county_od_trip_mode <- county_od_trip_mode %>% 
    select("orig_county", "dest_county", "trip_mode", "trips1", "trips2",	"revenue1", "revenue2", "fare1", "fare2",	"bau_fare1", "bau_fare2",	"num_participants1", "num_participants2", "walktime1", "walktime2", "wait1", "wait2", "IVT1", "IVT2", "transfers1", "transfers2", "othercost1", "othercost2", "distance1", "distance2", "dLocal1", "dLocal2", "dRegional1", "dRegional2", "dFree1", "dFree2", "dInterCity1", "dInterCity2", "ddist1", "ddist2", "dFareMat1", "dFareMat2") %>%
