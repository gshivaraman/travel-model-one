CompareStr_TM152_STR_T7 <- function(workbook1, workbook2) {
  ...
  trip_mode <- trip_mode %>% 
    select("trip_mode", "trips1", "trips2",	"revenue1", "revenue2", "fare1", "fare2",	"num_participants1", "num_participants2", "walktime1", "walktime2", "wait1", "wait2", "IVT1", "IVT2", "transfers1", "transfers2", "othercost1", "othercost2", "distance1", "distance2", "ddist1", "ddist2") %>%
    arrange("trip_mode")
  ...
  for (myvar in c("incQ", "timeCodeNum", "ptype", "home_taz")) {
    ...
    mydf <- mydf %>% 
      select(all_of(myvar), "trip_mode", "trips1", "trips2",	"revenue1", "revenue2", "fare1", "fare2",	"num_participants1", "num_participants2", "walktime1", "walktime2", "wait1", "wait2", "IVT1", "IVT2", "transfers1", "transfers2", "othercost1", "othercost2", "distance1", "distance2", "ddist1", "ddist2") %>%
  ...
  county_od_trip_mode <- county_od_trip_mode %>% 
    select("orig_county", "dest_county", "trip_mode", "trips1", "trips2",	"revenue1", "revenue2", "fare1", "fare2",	"num_participants1", "num_participants2", "walktime1", "walktime2", "wait1", "wait2", "IVT1", "IVT2", "transfers1", "transfers2", "othercost1", "othercost2", "distance1", "distance2", "ddist1", "ddist2") %>%
